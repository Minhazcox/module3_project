...
// create a function to load tasks from tasks file
...
// check if the form submitted using POST request

if ($_SERVER['REQUEST_METHOD'] === 'POST') {

    // check if task is provided, then add it to the tasks array and save
    ...
    if (isset($_POST['task']) && !empty(trim($_POST['task']))) {
        ...
        // check if a delete action is requested, remove the task from the array, and save
        ...
        // check if toggle action is requested, update task's done status, and save
